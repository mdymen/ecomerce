...
CREATE TABLE `pedidos` (
  `ID_ID_PED` INT NOT NULL AUTO_INCREMENT,
  `ST_NOME_PED` VARCHAR(100) NOT NULL,
  `ST_SOBRENOME_PED` VARCHAR(100) NOT NULL,
  `ST_EMAIL_PED` VARCHAR(100) NOT NULL,
  `ST_TELEFONE_PED` VARCHAR(45) NOT NULL,
  `ST_ENDERECO_PED` VARCHAR(255) NOT NULL,
  `ID_ESTADO_PED` INT NOT NULL,
  `ID_CIDADE_PED` INT NOT NULL,
  `ID_PAIS_PED` INT NOT NULL,
  `ST_CEP_PED` VARCHAR(45) NOT NULL,
  `ST_COMENTARIO_PED` TEXT NULL,
  PRIMARY KEY (`ID_ID_PED`));

CREATE TABLE `pedidos_produtos` (
  `ID_ID_PED` INT NOT NULL,
  `ID_PRODUTO_PED` INT NOT NULL);

ALTER TABLE `pedidos` 
CHANGE COLUMN `ID_ESTADO_PED` `ID_ESTADO_PED` VARCHAR(255) NOT NULL ,
CHANGE COLUMN `ID_CIDADE_PED` `ID_CIDADE_PED` VARCHAR(255) NOT NULL ;

ALTER TABLE `produtos` 
CHANGE COLUMN `VL_PRECO_PROD` `VL_PRECO_PROD` DECIMAL(3,0) NOT NULL ;

ALTER TABLE `produtos` 
ADD COLUMN `ST_BOTAO_PROD` TEXT NULL AFTER `NM_STOCK_PROD`;
